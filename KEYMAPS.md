...
| **\<leader>oi** | n | `ftplugin/markdown.lua` | Open image/link under cursor in default app (markdown-local) |
| **O** | n | `lua/plugins/snacks.lua` | Explorer: open item under cursor in OS default app (image viewer, etc.) |
